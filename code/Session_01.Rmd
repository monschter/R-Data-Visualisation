...
ggplot(aiddata_subset, aes(y = amount_total, x = region, group = region)) +
...
aiddata_yearly %>%
  ggplot(mapping = aes(x = commitment_year,
                       y = amount_total)) +
  labs(x = "commitment year", y = "total amount", title = "Amount of development finances committed to by the Chinese government") +
  geom_col() +
  theme_minimal()
