...
# runner <- read_csv("distanceWalkingRunning4.csv")
# runner <- read.csv("distanceWalkingRunning4.csv", header = TRUE)

#runner <- fread("sed 's/\\0//g' distanceWalkingRunning4.csv")

# runner <- read.csv("distanceWalkingRunning4.csv", stringsAsFactors = FALSE)
# runner <- read.csv(file = "distanceWalkingRunning4.csv", sep = ";", header = TRUE)
# library(readr)
# runner <- read_csv(file = "distanceWalkingRunning4.csv", sep = ";", na.strings = "NULL", header = TRUE)
# runner <- read.table("DistanceWalkingRunning2.txt",
#                      header = FALSE,
